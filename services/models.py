...
class Installation(models.Model):
    ...
    client = models.ForeignKey(
        "clients.Client", on_delete=models.CASCADE, related_name="installations"
    )
    technicians = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="installations"
    )
...
class MaintenanceContract(models.Model):
    client = models.ForeignKey(
        "clients.Client", on_delete=models.CASCADE, related_name="maintenance_contracts"
    )
...
class Service(models.Model):
    ...
    category = models.CharField(
        max_length=50, choices=CATEGORY_CHOICES, default="devis"
    )
    client = models.ForeignKey(
        "clients.Client",
        on_delete=models.SET_NULL,
