...
SECRET_KEY = os.getenv(
    "SECRET_KEY",
    "django-insecure-=*09)e4!xl^e*b2cqa9^@)vch*y8hz1%*dx0j!+!pea$g5)2=&",
)
...
db_required_env = ["DB_NAME", "DB_USER", "DB_PASSWORD", "DB_HOST"]
if all(os.getenv(env_key) for env_key in db_required_env):
    DATABASES = {
        "default": {
